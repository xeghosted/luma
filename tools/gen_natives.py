...
Outputs:
  ...
  scripts/rdr2/natives.lua     Lua bindings, name -> (rva, signature)
  editor/lua-defs/rdr2/natives.def.lua  LSP definitions for autocomplete
"""
import argparse
import json
import os
...
def main():
    ...
    for sub in (("src", "game", "rdr2"), ("scripts", "rdr2"), ("editor", "lua-defs", "rdr2")):
...
""")
    ...
    # ---- natives.lua -----------------------------------------------------
    out_lua = os.path.join(root, "scripts", "rdr2", "natives.lua")
...
""")
    ...
    # ---- LSP defs --------------------------------------------------------
    out_def = os.path.join(root, "editor", "lua-defs", "rdr2", "natives.def.lua")
